...
public class WebBrowser extends JFrame implements ActionListener,HyperlinkListener 
{
	...
	v3.write("<lock profile><web1>http://www.youtube.com</web1><web2>http://www.yahoo.com<web2><web3>http://www.orkut.com</web3><web4>http://www.facebook.com</web4><web5>http://www.ibibo.com<web5>      </lock profile>");
	v3.close();
	}
...
int v=ScrollPaneConstants.VERTICAL_SCROLLBAR_ALWAYS;
	...
	editorPane.setPage(t);
	 }catch(Exception hyu){ System.out.println("Error:"+hyu);}
	}
	});
	...
	System.out.println("Address store into Memory");
	 ...
	 File rt=new File("C:/error.html");
				    ...
				    {	
				    FileWriter w=new FileWriter("C:/error2.html");
				    w.write("<Html> <head> Server not Found (Subsiquential Error Details) <head>"+"\n\r"
					   +" <Title> Error</Title></head>"	
					   +"<Body> <Body> <h1> The page cannot be displayed </h1>" 
                                            +"The page you are looking for is currently unavailable.</br> \n\r  The Web site might be experiencing technical difficulties,</br> \n\r or you may need to adjust your browser settings.</br>" 
					    +"	<h3> <u><b>Url ="+textField.getText()+"</b></u></h3><br> Please Search On <a href a=http://www.google.co.in> Google </a></body><html>"	);
	...
	if(str11.equals("krishna") && str22.equals("krishna"))
	{
	if(nan%2==0)
	{
	...
	JOptionPane.showMessageDialog((Component)null,"Check the Password","Password Not Match",JOptionPane.OK_OPTION);
	}
	}
	});
...
//HyperLink
	...
	for(int k=0;k<len3;k++)
 	{
	           ...
	           // System.out.println(ch);
				 ...
				 System.out.println("web5=" + str5);	
				  ...
				  }catch(Exception frt){System.out.println(frt);}
	...
	for(int k=0;k<len3;k++)
     ...
     {
		System.out.println("\n\n\n"); 	
		System.out.print(" STARTING WEBLY... ");
		 for(int i=0;i<10;i++)
		 {
		 for(int j=0;j<5;j++)
		 {
...
l2=new JLabel("Software Title : WEBLY");
l2.setBounds(50,10,200,20);
cp.add(l2);

l2=new JLabel("Software Author :Krishna Pandey");
l2.setBounds(50,30,200,20);
cp.add(l2);

l2=new JLabel("Special Thanks: Github and stack overflow ");
